...
latex_documents = [
    (master_doc, 'python-package-template.tex', 'python-package-template Documentation',
...
man_pages = [
    (master_doc, 'python-package-template', 'python-package-template Documentation',
     [author], 1)
]
